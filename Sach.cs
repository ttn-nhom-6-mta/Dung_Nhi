...
inner join TacGia ON S.MaTG=TacGia.MaTG";
        ...
        private void binding()
        {
            ...
            cmbMaTL.DataBindings.Add("Text", dtgvsach.DataSource, "TenTheLoai");
            cmbMaTG.DataBindings.Add("Text", dtgvsach.DataSource, "TenTG");
        ...
        private void btLuu_Click(object sender, EventArgs e)
        {
            if (validate())
            {
                ...
                if (state == "insert")
                {
                    ...
                    string sql = @"INSERT INTO [QLTV_CHUNG].[dbo].[Sach]([MaSach],[TenSach],[NXB],[NamXB],[GiaTien],[SoTrang],[TinhTrangSach],[MaTheLoai],[MaTG],[SoLuong])
     VALUES
           ('" + txtmasach.Text + @"'
           ,N'" + txttensach.Text + @"'
            ,N'" + txtnxb.Text + @"'
           ...
           ," + cmbMaTG.SelectedValue + @" 
            ," + Convert.ToInt64(txtsoluong.Text) + @"  )";
                ...
                {
                    string sql = @"UPDATE [QLTV_CHUNG].[dbo].[Sach]
